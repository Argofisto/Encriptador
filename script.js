function focus() {
  ...
  function encriptar_o_desencriptar(flag) {
    ...
    document.getElementById("logo-b").style.display = "none";
    document.getElementById("texto-bloque-der").style.display = "none";
    document.getElementById("salida-texto").style.display = "inline-block";
    document.getElementById("salida-texto").innerHTML = texto;
    
    value();
  }
  
   function copiar(){
      var contenido = document.querySelector("#salida-texto"); 
      contenido.select();
